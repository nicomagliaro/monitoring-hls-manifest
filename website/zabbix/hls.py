...
class Stream():
    ...
    def __init__(self, host, path, port=None, ssl=False, timeout=25, token=None):
    ...
    def retrieve_segments(self, parent_addr, playlist, duration=30, download_dir='/var/tmp/hls'):
